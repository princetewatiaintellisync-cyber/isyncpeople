...
import '../utils/reimbursement_api.dart';
...
class _ReimbursementPageState extends State<ReimbursementPage> {
  ...
  // ── Column widths — 8 columns (no Approved Date / Approved By) ───────────
  static const Map<int, TableColumnWidth> _colWidths = {
    0: FixedColumnWidth(60),  // SR. NO
    1: FixedColumnWidth(150), // CLAIM NO
    2: FixedColumnWidth(110), // CLAIM DATE
    3: FixedColumnWidth(260), // EMPLOYEE NAME(PAYCODE)
    4: FixedColumnWidth(160), // EMPLOYEE DEP(DES)
    5: FixedColumnWidth(220), // PURPOSE
  ...
  Future<void> _loadPermissions() async {
    final canWrite = await _permissionService.canWrite('Reimbursement');
  ...
  Future<void> _fetchData() async {
    ...
    try {
      final data = await _apiService.fetchReimbursements();
      if (mounted) {
        setState(() {
          claimData = data;
          filteredData = data;
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to load reimbursements: ${e.toString()}'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Reimbursement Claim History'),
              ...
              child: Container(
                ...
                child: isLoading
                    ...
                    : SingleChildScrollView(
                        ...
                        child: SizedBox(
                          width: 60 + 150 + 110 + 260 + 160 + 220 + 130 + 100.0,
                          child: Column(
