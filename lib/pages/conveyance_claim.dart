...
import '../utils/conveyance_claim_api.dart';
import '../utils/permission_service.dart';

class ConveyanceClaimPage extends StatefulWidget {
  const ConveyanceClaimPage({super.key});

  @override
  State<ConveyanceClaimPage> createState() => _ConveyanceClaimPageState();
}

class _ConveyanceClaimPageState extends State<ConveyanceClaimPage> {
  final ConveyanceClaimApiService _apiService = ConveyanceClaimApiService();
  ...
  List<Map<String, dynamic>> claimData = [];
  ...
  static const Map<int, TableColumnWidth> _colWidths = {
    ...
    3: FixedColumnWidth(230), // EMPLOYEE NAME(PAYCODE)
  ...
  Future<void> _loadPermissions() async {
    final canWrite = await _permissionService.canWrite('Conveyance Claim');
  ...
  Future<void> _fetchData() async {
    ...
    try {
      final data = await _apiService.fetchConveyanceClaims();
      if (mounted) {
        setState(() {
          claimData = data;
          filteredData = data;
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to load conveyance claims: ${e.toString()}'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Conveyance Claim History'),
              ...
              child: Container(
                ...
                child: isLoading
                    ...
                    : SingleChildScrollView(
                        ...
                        child: SizedBox(
                          width: 60 + 140 + 110 + 230 + 160 + 120 + 130 + 100 + 120 + 140.0,
                          child: Column(
                            ...
                            children: [
                              ...
                              // Body
                              if (claimData.isEmpty && !isLoading)
                                const Padding(
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Showing ${claimData.isEmpty ? 0 : 1}–${claimData.length} of ${claimData.length}',
